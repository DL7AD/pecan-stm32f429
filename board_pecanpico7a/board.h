...
#define GPIOA_BUTTON                9U
#define GPIOA_MEMS_INT1             10U
...
#define LINE_BUTTON                 PAL_LINE(GPIOA, 9U)
#define LINE_MEMS_INT1              PAL_LINE(GPIOA, 10U)

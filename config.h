...
#define MODULES() { \
	...
	MODULE_IMAGE    (TX_CONTINUOSLY,          SLEEP_WHEN_BATT_BELOW_3V2,  CUSTOM_FREQ,      13,   PROT_SSDV_2FSK      ); \
/*	MODULE_IMAGE    (TX_CONTINUOSLY,          SLEEP_WHEN_BATT_BELOW_3V5,  CUSTOM_FREQ,      10,   PROT_SSDV_APRS_AFSK );*/ \
	MODULE_POSITION (WAIT_FOR_TRACKING_POINT, SLEEP_WHEN_BATT_BELOW_3V2,  CUSTOM_FREQ,      10,   PROT_UKHAS_2FSK     ); \
